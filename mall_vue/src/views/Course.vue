      ...
      <div class="type">
        <div class="type-wrap">
          ...
          <div class="two warp">
            ...
            <ul class="items">
              <li :class="{cur:course.current_category===0}" @click.prevent.stop="course.current_category=0"><a href="">不限</a></li>
              <li :class="{cur:course.current_category===category.id}" @click.prevent.stop="course.current_category=category.id" v-for="category in course.category_list"><a href="">{{category.name}}</a></li>
            </ul>
          </div>
        </div>
      </div>
...
get_category();  // at start, display the category_list
